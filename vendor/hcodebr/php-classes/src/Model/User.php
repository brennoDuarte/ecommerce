...
class User extends Model{
	...
	public static function getForgot($email, $inadmin = true){
		...
		$results = $sql->select("
			SELECT * FROM tb_persons a INNER JOIN tb_users b USING(idperson) WHERE a.desemail = :email;", array(":email"=>$email));
	...
	public function getOrders(){
		...
		$results = $sql->select("
			...
			INNER JOIN tb_persons f ON f.idperson = d.idperson WHERE a.iduser = :iduser", [
				":iduser"=>$this->getiduser()
			]);
